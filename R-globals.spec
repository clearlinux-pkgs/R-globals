...
Version  : 0.13.1
Release  : 28
URL      : https://cran.r-project.org/src/contrib/globals_0.13.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/globals_0.13.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602523588
