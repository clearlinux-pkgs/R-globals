...
Version  : 0.15.0
Release  : 43
URL      : https://cran.r-project.org/src/contrib/globals_0.15.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/globals_0.15.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652107100
